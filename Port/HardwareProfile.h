...
// based on processor selected in MPLAB
	...
	#if defined(__18F97J60) || defined(_18F97J60)|| defined(_18F87J60)||defined(__18F87J60) 
		#define PICDEMNET2
...
// Set configuration fuses (but only once)
			...
			#pragma config WDT=OFF, FOSC2=ON, FOSC=HSPLL, ETHLED=ON //zj set WDT ON now
...
// PIC18 Explorer + Fast 100Mbps Ethernet PICtail Plus or Ethernet PICtail
	...
	#define LED1_IO				(deviceAlarm1.fan[0]-0x30)
	#define LED2_TRIS			(TRISDbits.TRISD2)
	#define LED2_IO				(deviceAlarm1.templvl[0]-0x30)
	#define LED3_TRIS			(TRISDbits.TRISD3)
	#define LED3_IO				(deviceAlarm1.rfon[0]-0x30)
	#define LED4_TRIS			(TRISDbits.TRISD4)
	#define LED4_IO				(deviceAlarm1.rflow[0]-0x30)
	#define LED5_TRIS			(TRISDbits.TRISD5)
	#define LED5_IO				(LATDbits.LATD5)
	#define LED6_TRIS			(TRISDbits.TRISD6)
	#define LED6_IO				(deviceAlarm1.fetbias[0]-0x30)
	#define LED7_TRIS			(TRISDbits.TRISD7)
	#define LED7_IO				(deviceAlarm1.Lo[0]-0x30)
	#define LED_GET()			(LATD)
...
//	#define ENC100_ISR_PRIORITY		(INT2IP)
	...
	// 25LC256 I/O pins
	#define EEPROM_CS_TRIS		(TRISF7)
	#define EEPROM_CS_IO		(LATF7)
...
//               Fast 100Mbps Ethernet PICtail Plus or Ethernet PICtail Plus or ZeroG ZG2100M WiFi PICtail Plus
	...
	#define UARTTX_TRIS			(TRISFbits.TRISF4)
	#define UARTTX_IO			(PORTFbits.RF4)
...
**/
	...
	#define LED7_IO				(LATBbits.LATB5)
//	#define LED_GET()			(LATF)
//	#define LED_PUT(a)			(LATF = (a))
...
#endif
	// LCD I/O pins
	#define LCD_DATA_TRIS		(TRISA)//here
	#define LCD_DATA_IO			(LATA)
	#define LCD_RD_WR_TRIS		(TRISAbits.TRISA1)
	#define LCD_RD_WR_IO		(LATAbits.LATA1)
	#define LCD_RS_TRIS			(TRISAbits.TRISA2)
	#define LCD_RS_IO			(LATAbits.LATA2)
	#define LCD_E_TRIS			(TRISAbits.TRISA0)
	#define LCD_E_IO			(LATAbits.LATA0)//zj0413 H->A
...
// Define your own board hardware profile here
	...
	#define BusyUART2()				BusyUSART2()
	#define CloseUART2()				CloseUSART2()
	#define ConfigIntUART(a)		ConfigIntUSART(a)
	#define DataRdyUART2()			DataRdyUSART2()
	#define OpenUART(a,b,c)			OpenUSART(a,b,c)
	#define ReadUART2()				ReadUSART2()
	#define WriteUART2(a)			WriteUSART2(a)
	#define getsUART2(a,b,c)			getsUSART2(b,a)
	#define putsUART2(a)				putsUSART2(a)
	#define getcUART2()				ReadUSART2()
	#define putcUART2(a)				WriteUSART2(a)
	#define putrsUART2(a)			putrsUSART2((far rom char*)a)
