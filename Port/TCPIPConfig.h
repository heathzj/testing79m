...
/*  #define STACK_USE_SNMP_SERVER  JuZh Disable*/			// Simple Network Management Protocol v2C Community Agent
...
#define MPFS_RESERVE_BLOCK                (0x600) // (600ul) 591
...
**/
#define MY_DEFAULT_MAC_BYTE1            (0x00)	// Use the default of
#define MY_DEFAULT_MAC_BYTE2            (0x11)	// 00-11-01-01-00-00 if using
#define MY_DEFAULT_MAC_BYTE3            (0x01)	// an AGLIS MAC
#define MY_DEFAULT_MAC_BYTE4            (0x01)	// and wish to use the internal
#define MY_DEFAULT_MAC_BYTE5            (0x00)	// factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x00)	// address instead.
...
// -- HTTP2 Server options -----------------------------------------------
	...
	#define HTTP_USE_POST					// Enable POST support     (2.57kb ROM, ~0b RAM)
